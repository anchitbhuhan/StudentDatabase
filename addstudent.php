...
<html lang="en" dir="ltr">
 ...
 -->
    ...
    <table style="background-color: #003366;color: white;margin-left: 170px;margin-top: 30px;">
      <tr>
        <th>BOOK 1</th>
        <th>BOOK 2</th>
        <th>BOOK 3</th>
      ...
      <tr>
        ...
        <td><input type="text" name="date_out3" placeholder="Date Out" onfocus="(this.type='date')"></td>
      </tr>
      <tr>
        <td><input type="text" name="due_date1" placeholder="Date In" onfocus="(this.type='date')"></td>
        <td><input type="text" name="due_date2" placeholder="Date In" onfocus="(this.type='date')"></td>
        <td><input type="text" name="due_date3" placeholder="Date In" onfocus="(this.type='date')"></td>
      </tr>
    </table>

          <button type="submit" name="submit" style="margin-left: 400px">Add</button>
