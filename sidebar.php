...
<aside class="nav-sidebar" >
	...
	<ul>
		<li><span>Student Details</span></li>
		<li><a href="#" onclick="document.getElementsByClassName("fieldset").innerHTML='bjfgjf'">Personal Details</a></li>
